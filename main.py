...
def trends(request: ScrappingRequest):
    Scrapping.gooole_trends(request.param, request.country, request.period, request.initial_date,
                            request.end_date,request.interest_over_time,
                            request.interest_by_subregion,
                            request.related_issues,
                            request.related_searches) 
